  ...
  return (
    <div className="poseInfo">
      <div className="yoga-item big">
        <h1 className="heading about-h">About</h1>
        <p className="pose-description about-d">
      ...
      <img className="yoga-image about-img" src="./src/assets/yoga-pose20.png" alt="yoga-pose2" />
    </div>
  );
};
